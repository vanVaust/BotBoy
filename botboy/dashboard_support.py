...
from botboy.security.replay_diff import summarize_replay_diffs
...
def _build_control_center_contract(
    *,
    ...
    replay_segment = {
        ...
        "replay_diff": replay_diff_summary,
        "source": "dashboard_support",
    }
...
def get_dashboard_payload(bot, mode: str = "local") -> dict[str, Any]:
    ...
    replay_diff_summary = summarize_replay_diffs(task_store) if task_store else {"available": False}
    ...
    operations_summary = {
        ...
        "replay_diff_total": int(replay_diff_summary.get("total", 0) or 0),
        "replay_diff_drift_count": int(replay_diff_summary.get("drift_count", 0) or 0),
